...
import { denoiseAudio, NoiseType, SNR } from '@/services/audio-api';
...
export default function NoiseReducerScreen() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      // Call the denoise API
      const response = await denoiseAudio(
        selectedFile.uri,
        'None' as NoiseType, // Default values, you can add UI to select these
        '10' as SNR
      );
